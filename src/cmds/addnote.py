...
async def action_slash(ctx: ApplicationContext, user_id: Option(str, 'User ID or @mention name.'), note: Option(str, 'The note to add. Will be sent to the user in a DM as well.')):
